...
BEGIN
    ...
    ('iPad Pro 12.9', 'Apple', 2, 'iPadOS', '17.0', 'M2', 16, 'Top-tier performance for video editing.', 1),
    ...
    ('Surface Pro 9', 'Microsoft', 2, 'Windows', '11', 'Intel Core i7', 16, 'Hybrid device for management team.', 1);
END
GO